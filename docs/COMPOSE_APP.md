...
chess-piece drawings and launcher icon are original code/vector assets, and move/capture
sounds are synthesized by project code rather than loaded from a sampled recording. Their
