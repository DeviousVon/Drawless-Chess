...
require_text "$REPOSITORY_ROOT/docs/AUDIO_PROVENANCE.md" '101 high-quality stereo, 48 kHz Ogg/Vorbis resources'
...
require_text "$REPOSITORY_ROOT/scripts/verify-sampled-audio.ps1" '0c7f66a055fc93bfd7d71470777fd6b636f33baeefd5b23eb9fae06486499c9f'
