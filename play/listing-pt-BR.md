# Página da Google Play — português (Brasil)

> **RASCUNHO — REQUER REVISÃO NATIVA E DE XADREZ**
>
> Não publicar esta página antes das duas revisões. A terminologia das regras variantes deve ser validada por enxadristas brasileiros.

## Nome do app

`Drawless Chess`

Contagem de caracteres: 14 de 30.
...
```text
Toda partida tem um vencedor.

Drawless Chess adapta regras conhecidas do xadrez para substituir finais comuns em empate por resultados decisivos. O xeque-mate continua vencendo, mas as regras do Drawless mantêm a disputa:
...
• Controles de dica, desfazer, pausa, giro do tabuleiro e desistência
• Revanches após o fim da partida
• Histórico local da carreira, sequências, resultados por adversário e pontuações motivacionais por partida
...
- Confirmar se **afogamento**, **posição morta**, **en passant**, **roque pequeno/grande** e **regra dos 50 lances** são naturais e tecnicamente precisos para enxadristas brasileiros.
- Manter **Drawless Chess** e os nomes dos personagens sem tradução.
- Confirmar se **Partida rápida**, **Escape** e os nomes traduzidos dos cinco temas correspondem ao texto final dentro do app.
- Revisar capturas de tela localizadas e todo texto acrescentado após este rascunho antes da publicação.
