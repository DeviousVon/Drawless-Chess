# Google-Play-Eintrag — Deutsch (Deutschland)

> **DRAFT — NATIVE/CHESS REVIEW REQUIRED**
>
> Dieser Entwurf darf vor einer Prüfung durch einen deutschen Muttersprachler mit
> Schachkenntnissen nicht im Google Play Console veröffentlicht werden.

## App-Name

`Drawless Chess`

Zeichenanzahl: 14 von 30.
...
```text
Jede Partie hat einen Sieger.

Drawless Chess gestaltet vertraute Schachregeln neu und ersetzt übliche Remis-Enden durch klare Entscheidungen. Schachmatt gewinnt weiterhin, doch die Drawless-Regeln halten den Kampf am Laufen:
...
• Hinweise, Rücknahme, Pause, Brettdrehung und Aufgabe
• Revanche nach einer beendeten Partie
• Lokale Karrierebilanz, Serien, Gegnerauswertung und motivierende Partiepunktzahlen
...
- Sprache: **Deutsch (Deutschland) — de-DE**
...
- Deutsche Grammatik, Tonalität und natürliche Formulierungen durch einen
  Muttersprachler prüfen lassen.
- Die Schachbegriffe „Patt“, „tote Stellung“, „dreimalige
  Stellungswiederholung“, „Schlagzug“, „Bedenkzeit“ und „Rochade“ von einem
  deutschsprachigen Schachspieler bestätigen lassen.
- Zeichenanzahlen nach dem Einfügen in die Play Console erneut prüfen; Google
  kann Zeilenumbrüche und Unicode-Zeichen anders darstellen.
- Screenshots und Bildtexte müssen zur endgültigen deutschen App-Oberfläche
  passen.
