...
> **BORRADOR — REQUIERE REVISIÓN DE UN HABLANTE NATIVO Y DE UN AJEDRECISTA**
>
> No publicar esta ficha hasta completar ambas revisiones. Traducción orientada a `es-419` neutral; los términos de reglas variantes deben validarse con ajedrecistas de los mercados objetivo.

## Nombre de la app

`Drawless Chess`

Cantidad de caracteres: 14 de 30.
...
```text
Cada partida tiene un ganador.

Drawless Chess adapta las reglas conocidas del ajedrez para reemplazar los finales habituales en tablas por resultados decisivos. El jaque mate sigue dando la victoria, pero las reglas de Drawless mantienen la lucha:
...
• Controles de pista, deshacer, pausa, giro del tablero y rendición
• Revanchas después de terminar una partida
• Registro local de tu trayectoria, rachas, estadísticas por oponente y puntuaciones motivacionales por partida
...
Borrador para la versión `1.0.1` (`versionCode` 5):
...
- Confirmar que **ahogado**, **posición muerta**, **captura al paso**, **enroque corto/largo** y **regla de los 50 movimientos** resulten naturales y técnicamente precisos en los principales mercados hispanohablantes objetivo.
- Mantener **Drawless Chess** y los nombres de personajes sin traducir.
- Confirmar si **Partida rápida**, **Escape** y los nombres traducidos de los cinco temas coinciden con el texto final dentro de la app.
- Revisar capturas de pantalla localizadas y cualquier texto añadido después de este borrador antes de publicar.
